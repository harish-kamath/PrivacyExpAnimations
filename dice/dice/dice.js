...
(function(dice) {
    ...
    this.known_types = ['d12'];
    this.dice_face_range = { 'd12': [1, 11]};
    this.dice_mass = { 'd12': 350};
    this.dice_inertia = { 'd12': 8 };
    ...
    this.create_d12 = function() {
        if (!this.d12_geometry) this.d12_geometry = this.create_d12_geometry(this.scale);
    ...
    this.dice_box.prototype.prepare_dices_for_roll = function(vectors) {
        ...
        var i = vectors[0];
            this.create_dice(i.set, i.pos, i.velocity,
                    i.angle, i.axis);
        //}
    }
    ...
    this.dice_box.prototype.draw_selector = function() {
        ...
        //for (var i = 0, pos = 0; i < that.known_types.length; ++i, ++pos) {
            var dice = $t.dice['create_' + that.known_types[0]]();
            dice.position.set(0, 0, step * 0.5);
            dice.castShadow = true;
            dice.userData = that.known_types[0];
            this.dices.push(dice);
            this.scene.add(dice);
        //}
